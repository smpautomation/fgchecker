...
const cameraTarget = ref('operator')
...
.scan-hero {
    position: relative;
    padding: 36px clamp(16px, 5vw, 56px) 8px;
    overflow: hidden;
}
.hazard-strip {
    position: absolute;
    ...
    right: 0;
    height: 6px;
    background: repeating-linear-gradient(135deg, var(--accent) 0 18px, var(--bg-2) 18px 36px); opacity: 0.9;
}
.eyebrow {
